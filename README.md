...
-   High DPI awareness. By default the game will not run in high DPI mode, but it will be aware of it, so that things at least don't look fuzzy when you have weird scaling settings (this still needs more testing though).
